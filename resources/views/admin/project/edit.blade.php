        ...
        <form action="{{ route('project.update', $project->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row ">
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="text" class="form-control" id="description" value="{{$project->description}}" name="description" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="date" class="form-control" id="started_at" value="{{$project->started_at}}" name="started_at" required>
                </div>

                <div class="form-group col-md-6">
                    <label for="deadline_at">Deadline Date</label>
                    <input type="date" class="form-control" id="deadline_at" value="{{$project->deadline_at}}" name="deadline_at" required>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" id="completion_at" value="{{$project->completion_at}}" name="completion_at" required>
                </div>
            </div>
