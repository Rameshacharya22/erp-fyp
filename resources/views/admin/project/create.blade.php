...
{{--                    <textarea class="form-control" value="{{old('description')}}" name="description" id="description" cols="30" rows="4"></textarea>--}}
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 ">
                    ...
                    <input type="date" value="{{old('started_at')}}" class="form-control" id="started_at" name="started_at" required min="{{\Carbon\Carbon::now()->format('Y-m-d')}}">
                </div>

                <div class="form-group col-md-6">
                    <label for="deadline_at"> Deadline Date</label>
                    <input type="date" value="{{old('deadline_at')}}" class="form-control" id="deadline_at" name="deadline_at" min="{{\Carbon\Carbon::now()->format('Y-m-d')}}" required>
                </div>
            </div>
